...
Return your decision in the following  list format only:

{{
  1. Candidate Status : "Selected" or "Rejected"
  2. Reason : "Explain the decision in detail with clarity in minimum of two or three sentences. Focus on the skills of the candidate and the experiences."
  3. Matched Skills : [list of matched skills]
  4. Skill Match Ppercentage : integer value (0-100)
  5. Experience : integer value (years of experience of the candidate)
}}
